...
studentSchema = new mongoose.Schema({
    ...
    regNum: {
        type: String,
        required: [true, "Please provide a name"],
        maxlength: [10, "Name should be under 50 characters"],
        unique:true
      },
    branch: {
        type: String,
      ...
      year: {
        type: Number,
        required: [true, "Please provide student's current Year of study"],
      },
      semester: {
        type: Number,
        required: [true, "Please provide student's current semester"],
      },
    personalEmail: {
        type: String,
    ...
    collegeEmail: {
        type: String,
        required: [true, "Please provide student college email"],
        validate: [validator.isEmail, "Please enter email in correct format"],
        unique: true,
      },
    phoneNumber: {
...
studentSchema.methods.isValidatedUser = async function(userPassword){
...
studentSchema.methods.getPasswordtoken = async function(){
